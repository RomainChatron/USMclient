...
public class createArticle extends JFrame {
	...
	public createArticle() {
		...
		label.setIcon(new ImageIcon(createArticle.class.getResource("/appTemoin1/images/48px-Icon-wiki.png")));
		...
		btnAjouterUneImage.setIcon(new ImageIcon(createArticle.class.getResource("/appTemoin1/images/image-inserer-icone-7309-48.png")));
		...
		btnNewButton.setBounds(33, 603, 206, 29);
		...
		btnNewButton_1.setBounds(254, 603, 206, 29);
		...
		cbGroup.setBounds(475, 605, 118, 26);
