...
public class DeleteGroupe extends JFrame {
	...
	public DeleteGroupe() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(DeleteGroupe.class.getResource("/appT\u00E9moin/images/fleches-echange.gif")));
		...
		label.setIcon(new ImageIcon(DeleteGroupe.class.getResource("/appT\u00E9moin/images/delete-user-group-icon-2897.png")));
		label.setBounds(29, 29, 103, 48);
		contentPane.add(label);
		
		JComboBox comboBox = new JComboBox();
		comboBox.setBounds(268, 103, 36, 26);
