...
public class CreerGroupe extends JFrame {
	...
	public CreerGroupe() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(CreerGroupe.class.getResource("/appT\u00E9moin/images/fleches-echange.gif")));
		...
		lblNewLabel.setIcon(new ImageIcon(CreerGroupe.class.getResource("/appT\u00E9moin/images/OMGFDP.png")));
