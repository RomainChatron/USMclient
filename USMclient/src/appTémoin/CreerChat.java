...
public class CreerChat extends JFrame {
	 ...
	 */
	public CreerChat() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(CreerChat.class.getResource("/appT\u00E9moin/images/fleches-echange.gif")));
		...
		lblNewLabel_1.setIcon(new ImageIcon(CreerChat.class.getResource("/appT\u00E9moin/images/par_chat.png")));
