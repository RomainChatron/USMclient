...
public class DeleteUser extends JFrame {
	...
	public DeleteUser() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(DeleteUser.class.getResource("/appT\u00E9moin/images/fleches-echange.gif")));
		...
		label.setIcon(new ImageIcon(DeleteUser.class.getResource("/appT\u00E9moin/images/delete-user-icon.png")));
